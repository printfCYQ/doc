...
| 步骤 | 建议章节 | 内容 / 时长 |
| --- | --- | --- |
| 第 1 步 | [第 0~1 章](#_0-先准备工具) | 工具和第一个网页（半天） |
| 第 2 步 | [第 2~5 章](#_2-常用标签-把内容排进页面) | 标签、语义化、表单、属性（1~2 天），多写多预览 |
| 第 3 步 | [第 6~8 章](#_6-css-入门-样式写在哪里) | CSS 引入、选择器、盒模型（1~2 天），盒模型是重点 |
| 第 4 步 | [第 9 章](#_9-布局-核心实战) | 布局 flex / grid / position（2~3 天），最难也最常用 |
| 第 5 步 | [第 10~13 章](#_10-常用样式速查) | 常用样式、响应式、动画、变量（2 天） |
| — | — | 以上能写静态页面 |
| 第 6 步 | [第 15 章](#_15-实战-写一个个人主页) | 实战个人主页（1~2 天） |
