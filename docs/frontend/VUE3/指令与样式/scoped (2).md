...
### 转载：[https://juejin.cn/post/7098569051860893709#heading-1](https://juejin.cn/post/7098569051860893709#heading-1)

### ⭐佛系回答

> 不就是给那啥加一个特殊标识，然后样式就被**唯一标记**，就实现了样式隔离的作用。
...
> **Scope CSS 的本质是基于 HTML 和 CSS 属性选择器**，即分别给 HTML 标签和 CSS 选择器添加 data-v-xxx；具体来说，它是 **通过 vue-loader 实现** 的，实现过程大致分 3 步：
> 
...
> 
> -   // 形如 \`id=7ba5bd90\` ： // template import {render,staticRenderFns} from "./App.vue?vue&type=template&id=7ba5bd90&scoped=true&"; // script import script from "./App.vue?vue&type=script&lang=js&"; // style import style0 from "./App.vue?vue&type=style&index=0&id=7ba5bd90&scoped=true&lang=css&"; 复制代码
